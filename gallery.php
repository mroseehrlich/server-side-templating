...
Name: Mia Ehrlich
Coding 06
Purpose: This is the php gallery page that loads the mustache templates for for a mobile first responsive
    site using bootstrap and jquery
 */
...
$body = file_get_contents('templates/gallery.html');
 ...
 * such as page title. in this way we can use a single header and footer template
